...
public class ListaCompletaAdapter extends ArrayAdapter<Projeto> {
    private Context contexto;
    private ArrayList<Projeto> elementos;

    public ListaCompletaAdapter(Context contexto, ArrayList<Projeto> elementos){
    ...
    public View getView(final int position, View ContentView, ViewGroup parent){
        ...
        View rowView = inflater.inflate(R.layout.linha_lista_completa, parent, false);
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                it.putExtra("image", elementos.get(position).getImage());
